...
function setup() {
    ...
    ball1=new BALLS(250	,400,50);
	ball2=new BALLS(350,400,50);
	ball3=new BALLS(450,400,50);
	ball4=new BALLS(550,400,50);
...
function keyPressed(){
	if (keyCode===UP_ARROW){
	Matter.Body.applyForce(ball1.body,ball1.body.position,{x:-380,y:-100});	
	}
}
